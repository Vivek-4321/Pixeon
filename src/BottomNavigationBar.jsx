...
function BottomNavigationBar() {
  return (
    ...
    <Link className="nav-item-link" to="/login"><div className="nav-item"><AiOutlineMessage/></div></Link>
    ...
    <Link className="nav-item-link" to="/otp_verification"><div className="nav-item"><CgProfile/></div></Link>
  </div>
  )
}
